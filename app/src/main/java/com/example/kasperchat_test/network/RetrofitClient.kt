...
object RetrofitClient {
    ...
    // или "http://192.168.0.4:5012/" если тестируете на реальном устройстве в той же Wi-Fi сети
    // или "http://185.130.224.155:5012/" для полноценного сервера
    private const val BASE_URL = "http://185.130.224.155:5012/" // Пример, используйте ваш актуальный URL
